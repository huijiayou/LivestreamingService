...
public class GameController {
    ...
    public void getGame(@RequestParam(value = "game_name", required = false) String gameName, HttpServletResponse response) throws ServletException, IOException {
        ...
        } catch (TwitchException | JsonProcessingException e) {
